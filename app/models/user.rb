...
class User < ApplicationRecord
  ...
  has_many :wallet_recharge_payments, dependent: :nullify
  has_many :parking_histories, class_name: 'Parking::History'
  ...
  validates :avatar, size: { less_than: 10.megabytes , message: I18n.t('activerecord.errors.models.user.attributes.avatar.too_long') }

  scope :without_wallets, -> { left_outer_joins(:wallet).where(wallets: { id: nil }) }

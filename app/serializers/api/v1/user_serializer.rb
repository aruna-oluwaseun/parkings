  ...
  module V1
    class UserSerializer < ::ApplicationSerializer
      attributes :email, :first_name, :last_name,
                 :phone, :created_at, :birthday,
                 :avatar, :default_credit_card_id,
                 :is_dev, :balance
      ...
      def vehicles
        object.vehicles.includes([:manufacturer]).map { |v| Api::V1::VehicleSerializer.new(v) }
      end

module AiEventsHelper
  def car_entrance_payload(plate_number = 'plate_number', send_images = true ,timestamp = 5.minutes.ago.to_i)
    vehicle_images = send_images ? [fixture_base64_file_upload('spec/files/test.jpg')] : nil
    {

...
ActiveRecord::Schema.define(version: 2021_01_25_123214) do
  ...
  create_table "agencies", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.string "phone"
    t.bigint "agency_type_id"
    t.index ["agency_type_id"], name: "index_agencies_on_agency_type_id"
  end
  ...
  create_table "ai_error_reports", force: :cascade do |t|
    t.integer "error_type"
    t.json "extra_data"
    t.bigint "parking_session_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["parking_session_id"], name: "index_ai_error_reports_on_parking_session_id"
  end
  ...
  create_table "parking_citation_tickets", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["violation_id"], name: "index_parking_citation_tickets_on_violation_id"
  end
  ...
  create_table "parking_histories", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["parking_session_id"], name: "index_parking_histories_on_parking_session_id"
  ...
  create_table "parking_lots", force: :cascade do |t|
    ...
    t.bigint "agency_id"
    t.index ["agency_id"], name: "index_parking_lots_on_agency_id"
  end
  ...
  create_table "parking_rules", force: :cascade do |t|
    ...
    t.bigint "admin_id"
    t.bigint "agency_id"
    t.index ["admin_id"], name: "index_parking_rules_on_admin_id"
  ...
  create_table "parking_sessions", force: :cascade do |t|
    ...
    t.float "fee_applied"
    t.bigint "kiosk_id"
    t.boolean "plate_number_verified", default: false
    t.string "ai_plate_number"
    t.string "ksk_plate_number"
  ...
  create_table "parking_settings", force: :cascade do |t|
    ...
    t.string "subject_type"
    t.bigint "subject_id"
    t.integer "incremental", default: 3600
    t.integer "court_duration", default: 25
  ...
  create_table "parking_violations", force: :cascade do |t|
    ...
    t.index ["plate_number"], name: "index_parking_violations_on_plate_number"
  ...
  create_table "user_notifications", force: :cascade do |t|
    ...
    t.bigint "parking_session_id"
    t.bigint "payment_id"
    t.bigint "wallet_recharge_payment_id"
    t.bigint "violation_id"
    t.integer "minutes_extended"
    t.index ["parking_session_id"], name: "index_user_notifications_on_parking_session_id"
    t.index ["payment_id"], name: "index_user_notifications_on_payment_id"
    t.index ["user_id"], name: "index_user_notifications_on_user_id"
    t.index ["violation_id"], name: "index_user_notifications_on_violation_id"
    t.index ["wallet_recharge_payment_id"], name: "index_user_notifications_on_wallet_recharge_payment_id"
  end
  ...
  create_table "wallet_recharge_payments", force: :cascade do |t|
    t.decimal "amount"
    t.bigint "user_id"
    t.integer "status", default: 0
    t.integer "payment_method"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_wallet_recharge_payments_on_user_id"
  end
  ...
  add_foreign_key "ai_error_reports", "parking_sessions"
  ...
  add_foreign_key "parking_citation_tickets", "parking_violations", column: "violation_id"
  add_foreign_key "parking_histories", "parking_sessions"
  ...
  add_foreign_key "user_notifications", "parking_violations", column: "violation_id"
  add_foreign_key "user_notifications", "payments"
  add_foreign_key "user_notifications", "wallet_recharge_payments"

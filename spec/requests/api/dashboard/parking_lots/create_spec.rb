...
RSpec.describe Api::Dashboard::ParkingLotsController, type: :request do
  ...
  describe 'POST #create' do
    before do
      allow(::Dashboard::Redis::SaveParkingLotPlaces).to receive(:call).and_return('OK')
    end
    ...
    context 'success' do
      ...
      it 'should create new location' do
        ...
        expect(parking_lot.location.present?).to be_truthy
      end
      ...
      it 'should save phone' do
        ...
        expect(parsed_body['phone']).to eq(parking_lot.phone)
      end
    end
    ...
    context 'fail: invalid params' do
      ...
      it 'should have location errors' do
        subject
        expect(json[:errors][:city].present?).to eq(true)
      end
    end
  end
end

  ...
  module Dashboard
    class CamerasController < ApplicationController
      ...
      param :order, Hash, 'Hash order' do
        param :keyword, Camera.attribute_names.without('password'), 'Order Keyword', required: false
      ...
      api :DELETE, '/api/dashboard/cameras/:id', 'Delete vehicle from user account'
      param :id, String, 'Camera id', required: true

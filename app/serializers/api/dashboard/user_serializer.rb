module Api
  module Dashboard
    class UserSerializer < ::ApplicationSerializer
      ...
      def actions
        role_permission = current_user.role.permissions.find_by(name: object.role.name&.camelcase || 'Admin')
        {
          update: role_permission.nil? ? false : role_permission.record_update,
          delete: role_permission.nil? ? false : role_permission.record_delete
        }
      end

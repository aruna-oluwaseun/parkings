    ...
    class ParkingLotsController < ::Api::Dashboard::ApplicationController
      wrap_parameters :parking_lot,
                      include: ParkingLot.attribute_names +
                        [:setting, :location, :parking_admin_id, :town_manager_id, :rules]
      ...
      param :order, Hash, 'Hash order' do
        param :keyword, ParkingLot.attribute_names + ['parking_admin', 'town_manager', 'full_address' ], "Order keyword", required: false
      ...
      param :parking_lot, Hash do
        ...
        param :location, Hash, required: true do
          ...
          param :building, String, required: false
          param :country, String, required: true
          param :zip, String, required: false
        ...
        param :setting, Hash do
          ...
          param :incremental, Integer
        end
        param :rules, Hash, required: true
        param :agency_id, Integer, required: false
      end
